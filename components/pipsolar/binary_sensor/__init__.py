...
CONF_FEED_TO_GRID = "feed_to_grid"
...
TYPES = [
    ...
    CONF_OVERHEAT_RESTART_FUNCTION,
    CONF_BACKLIGHT_ON,
    CONF_ALARM_ON_WHEN_PRIMARY_SOURCE_INTERRUPT,
    CONF_FAULT_CODE_RECORD,
    CONF_FEED_TO_GRID,
    CONF_LIBAT_IMMEDIATELY_TURNON,
    CONF_LIBAT_AUTO_TURNON,
